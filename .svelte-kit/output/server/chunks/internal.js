...
const options = {
  ...
  templates: {
    app: ({ head, body, assets, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets + `/favicon.png" />
		...
		<link href="https://fonts.googleapis.com/css2?family=Pixelify+Sans:wght@400;700&family=Libre+Franklin:wght@400;700&family=Tiny5&family=Micro+5&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&display=swap" rel="stylesheet">
