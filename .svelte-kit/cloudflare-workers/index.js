...
// node_modules/@sveltejs/kit/node_modules/esm-env/dev-fallback.js
...
// node_modules/@sveltejs/kit/node_modules/esm-env/index.js
...
var DEV2, DERIVED, EFFECT, BLOCK_EFFECT, BRANCH_EFFECT, ROOT_EFFECT, BOUNDARY_EFFECT, UNOWNED, DISCONNECTED, CLEAN, DIRTY, MAYBE_DIRTY, INERT, DESTROYED, EFFECT_RAN, EFFECT_TRANSPARENT, INSPECT_EFFECT, HEAD_EFFECT, EFFECT_PRESERVED, USER_EFFECT, REACTION_IS_UPDATING, ASYNC, ERROR_VALUE, STATE_SYMBOL, LEGACY_PROPS, PROXY_PATH_SYMBOL, STALE_REACTION, COMMENT_NODE, HYDRATION_START, HYDRATION_END, HYDRATION_ERROR, UNINITIALIZED, FILENAME, current_component, BLOCK_OPEN, BLOCK_CLOSE, autoclosing_children, disallowed_children, HeadPayload, Payload, parent, seen, controller, on_destroy;
...
var SCHEME, internal, subscriber_queue, valid_layout_exports, valid_page_exports, valid_layout_server_exports, valid_page_server_exports, valid_server_exports, validate_layout_exports, validate_page_exports, validate_layout_server_exports, validate_page_server_exports, validate_server_exports;
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.DJieG1IL.js", "_app/immutable/chunks/3KWLfpDR.js", "_app/immutable/chunks/CmzJJKhx.js", "_app/immutable/chunks/DPnZHem-.js"];
    stylesheets = ["_app/immutable/assets/0.C1TJ-Hds.css"];
    fonts = [];
  }
});
...
function Error$1($$payload, $$props) {
  ...
  $$payload.out.push(`${escape_html2(page.status)}</h1>`);
  pop_element();
  $$payload.out.push(` <p>`);
  push_element($$payload, "p", 6, 0);
  $$payload.out.push(`${escape_html2(page.error?.message)}</p>`);
  pop_element();
  pop();
}
var CONTENT_REGEX, page$1, page;
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.Bzgg-THU.js", "_app/immutable/chunks/3KWLfpDR.js", "_app/immutable/chunks/CmzJJKhx.js", "_app/immutable/chunks/DPnZHem-.js", "_app/immutable/chunks/DKXiWSxs.js", "_app/immutable/chunks/qJMkmo8-.js", "_app/immutable/chunks/g-oURhXx.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.BD8xZOjD.js", "_app/immutable/chunks/3KWLfpDR.js", "_app/immutable/chunks/CmzJJKhx.js", "_app/immutable/chunks/DPnZHem-.js", "_app/immutable/chunks/BL2QTzks.js", "_app/immutable/chunks/DKXiWSxs.js", "_app/immutable/chunks/NyzOKfwD.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/share/_date_/_shareId_/_page.svelte.js
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/share/_date_/_shareId_/_page.svelte.js"() {
    init_chunks();
    init_client();
    _page2[FILENAME] = "src/routes/share/[date]/[shareId]/+page.svelte";
    _page2.render = function() {
      throw new Error("Component.render(...) is no longer valid in Svelte 5. See https://svelte.dev/docs/svelte/v5-migration-guide#Components-are-no-longer-classes for more information");
    };
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.CLdJMg_r.js", "_app/immutable/chunks/3KWLfpDR.js", "_app/immutable/chunks/CmzJJKhx.js", "_app/immutable/chunks/BL2QTzks.js", "_app/immutable/chunks/NyzOKfwD.js", "_app/immutable/chunks/D300RiNs.js", "_app/immutable/chunks/g-oURhXx.js", "_app/immutable/chunks/qJMkmo8-.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/entries/endpoints/api/puzzle/_server.js
var server_exports = {};
...
async function GET({ platform }) {
  try {
    ...
    console.error("Error getting puzzle:", error2);
...
async function generateDailyPuzzle(dateString, env) {
  try {
    ...
    console.error("Error generating puzzle:", error2);
...
function parseRSSFeed(rssText) {
  ...
  let descMatch;
  let index5 = 0;
  while ((descMatch = descriptionRegex.exec(rssText)) !== null && index5 < headlines.length) {
    headlines[index5].description = descMatch[1].trim();
    index5++;
  }
...
function cleanText(text2, forbiddenTerms) {
...
async function analyzeWithLlama3(headlines, env) {
  ...
  try {
    ...
    console.error("Error with Llama3 analysis:", error2);
...
// .svelte-kit/output/server/entries/endpoints/api/share/_server.js
var server_exports2 = {};
...
async function POST({ request, platform }) {
  try {
    ...
    console.error("Error handling share API:", error2);
    return json({ error: error2.message }, { status: 500 });
  }
}
...
// .svelte-kit/output/server/entries/endpoints/api/share/_date_/_shareId_/_server.js
var server_exports3 = {};
__export(server_exports3, {
  GET: () => GET2
});
async function GET2({ params, platform }) {
  try {
...
init_equality();
var public_env = {};
var fix_stack_trace = (error2) => error2?.stack;
...
function update_effect(effect) {
  ...
  try {
    ...
    var dep;
    if (DEV2 && tracing_mode_flag && (effect.f & DIRTY) !== 0 && effect.deps !== null) ;
  } finally {
...
async function render_response({
  ...
  if (page_config.csr) {
    ...
    if (state2.prerendering && link_tags.size > 0) {
      head2 += Array.from(link_tags).map((tag2) => `
		${tag2}`).join("");
    }
...
var warned_on_devtools_json_request = false;
